  ...
  def module[Req, Rep]: Stackable[ServiceFactory[Req, Rep]] =
    new Stack.Module1[param.Traced, ServiceFactory[Req, Rep]] {
      ...
      def make(
        ...
        new TracedInitializerFilter[Req, Rep](traced.traced).andThen(next)
      }
    }
}
